...
export const DELETE_URL = (_id) => `http://localhost:4001/sounds/${_id}` //`https://icslap-p.herokuapp.com/sounds/${_id}`
//http://localhost:4001

export const TEST_URL = (slug) => `http://localhost:4001/sounds/play/${slug}` //`https://icslap-p.herokuapp.com/sounds/play/${slug}`   https://icslap-p.herokuapp.com/
