...
export const BASE_URL = "https://icslap-p.herokuapp.com/"  //"http://localhost:4001/"  
...
export const SOUND_URL = (slug) => `https://icslap-p.herokuapp.com/sounds/play/${slug}` //`http://localhost:4001/sounds/play/${slug}` //  https://icslap-p.herokuapp.com/